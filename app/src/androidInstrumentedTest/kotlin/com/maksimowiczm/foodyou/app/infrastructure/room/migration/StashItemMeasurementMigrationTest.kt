...
class StashItemMeasurementMigrationTest : AbstractStashItemMeasurementMigrationTest() {
    private val instrumentation = InstrumentationRegistry.getInstrumentation()
    private val file =
        instrumentation.targetContext.getDatabasePath("StashItemMeasurementMigrationTest.db")
