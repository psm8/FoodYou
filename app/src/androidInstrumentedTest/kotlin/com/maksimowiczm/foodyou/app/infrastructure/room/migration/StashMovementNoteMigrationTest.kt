...
class StashMovementNoteMigrationTest : AbstractStashMovementNoteMigrationTest() {
    private val instrumentation = InstrumentationRegistry.getInstrumentation()
    private val file = instrumentation.targetContext.getDatabasePath("StashMovementNoteMigrationTest.db")
